...
To supplement, appendices are given in \cref{part:app}. These appendices are being referred to throughout the text with exception of \label{app:shortcomings} which summarizes the shortcomings in this thesis.
