...
\begin{abstract}
    ...
    I denne afhandling udf{\o}res numeriske simuleringer af et plasma i en line{\ae}r maskine for at f{\aa} bedre indsigt i den komplekse turbulente transport, der finder sted der.

    Der udledes en tredimensionel drift-fluid model fra f{\o}rste principper for et plasma i en line{\ae}r maskine.
    For at tage h{\o}jde for fluktuationer i samme st{\o}rrelsesorden som baggrundsplasmaet, bliver der ikke lavet den traditionelle opdeling i baggrundsplasma og fluktuationer.
    Modellen er implementeret ved brug af BOUT++ frameworket og bliver l{\o}st numerisk.
        Der bliver lagt s{\ae}rlig v{\ae}gt p{\aa} hvordan singulariteten p{\aa} cylinder aksen behandles og p{\aa} inversionen af den ikkeline{\ae}re elliptiske ligning, der benyttes til at finde det elektriske potentiale.
    Udviklingen af plasmaet gennem ligev{\ae}gtstilstand, den line{\ae}re fase og den turbulente fase bliver unders{\o}gt og sammenlignet mellem forskellige $B$-felt styrker.
    ...
    Ydermere unders{\o}ges koherente strukturer fra den periodiske radielle flux i den turbulente fase.
    ...
    Det konstateres at ligev{\ae}gtstilstanden og den turbulente tilstand bifurkerer n{\aa}r interaktionen med neutrale dominerer over elektron-ion kollisioner.
\end{abstract}
