...
The variation of the $nu_{i,\|}$ field is smaller than the variation in the $u_{i,\|}$ as the sheath boundary condition (to be treated in \cref{sec:BCs}) will will accelerate the ions to the ion acoustic speed, and thus create a lower density around the sheath as compared with the rest of the paralell domain.
