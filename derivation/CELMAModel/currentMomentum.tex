...
\begin{align*}
 ...
 -m_i u_{i,\|}\partial_\|\L( n \L[u_{i,\|}+ u_{e,\|} \R]\R)
   \\&
 + \nu_{ei}\L(
   Zm_i \rho_s^2\frac{u_{i,\|}}{\mu} \grad_\perp^2 n
   - 0.51 m_e \frac{j_\|}{e}
   \R)
   \note{$q_in_i\simeq n$}
   \\&
...
\end{align*}
%
and that the momentum density for electrons reads (as $n_e \simeq n$)
%
\begin{align*}
...
\begin{align*}
 ...
 \\
 %
 \frac{1}{Z}\partial_t\L( n u_{i,\|}\R)
 =&
 -\frac{1}{ZJB}\L\{\phi, n u_{i,\|}\R\}
