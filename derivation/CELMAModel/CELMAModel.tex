...
\footnote{Note that a sheared laminar flow can cause a non-zero vorticity, and that irrational vortices exists.
    An intutive way to check whether a flow has a non-zero vorticity, is to check if a infinitesimal imagined stamp will rotate if introduced in a point of the flow.}
%
