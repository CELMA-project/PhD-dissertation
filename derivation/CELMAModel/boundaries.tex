...
% FIXME: Remove the comment below if Cauchy is not considere
...
However, we need some artificial boundary conditions around this area as our domains covers $\rho \in ]0, L_\rho[$ (where $L_\rho$ is the radius of the system) and we are using a FD scheme to calculate radial derivatives.
