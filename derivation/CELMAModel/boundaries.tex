...
This inversion takes into account the outer radial boundary condition in $\phi$, where the outer radial boundary condition can be set from the material properties of the wall.
