...
Finally, the normalization constant for the dynamic viscosities $\eta_{\a,n}$ can easily be found by looking at the dimensions of the RHS of equation (\ref{eq:nonElstat}) and the corresponding $\eta_{\a,n}$.
