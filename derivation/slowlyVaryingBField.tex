...
We therefore have $n\simeq Zn_i \simeq n_e$
...
\begin{align*}
    ...
    \\
    %
    e\partial_t n + eZ\div (n_i \ve{u}_i)
    - e\partial_t n - e\div (n_e \ve{u}_e)
    =&
    eZS_{i,n} - eS_{e,n}
    \\
    %
    \div (eZn_i \ve{u}_i - en_e \ve{u}_e) =&
    eZ\L(S_{i,n} - S_{e,n}\R)
\end{align*}
%
We will now use that the source produces equal amount of positive and negative charges, which means that $S_{n,e}=ZS_{n,i}=S_n$.
