...
Assuming we are working in a field aligned Clebsch coordinate system (see \cref{app:Clebsch}), where $\ve{b}$ is parallel to one of the basis vectors, we have that
%
\begin{align*}
