...
One often used method to close the set of equations, is the one suggested by Braginskii in his paper from $1965$ \cite{Braginskii1965}, which builds on the kinetic closure of gases derived by Chapman and Enskog \cite{Chapman1970, Brush1972}. A breif overview of this closure method is given in \cite{Fitzpatrick2014book}.
...
% FIXME: Requires characteristic speeds to be much larger then cs to communicate the temperature
