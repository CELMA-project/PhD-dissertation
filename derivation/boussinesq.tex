...
\begin{enumerate}[noitemsep]
    ...
    \item $\frac{\rho_s}{L_n}\ll1$ : This approximation usually holds as gradients in the background density are sharp as compared to $\rho_s$, but it may be that it is not orders of magnitude larger.
        % FIXME: Citation needed
