...
\Cref{app:elstat} discusses briefly when this approach is justifiable.
...
This is contrary to $\ve{u}_E$, called the $\ve{E}\time\ve{B}$-drift, which causes the same drift direction irrespective of charge.
