...
\end{align*}
%
In other words, we need to invert $A$ (that is $\L( \mathbb{I} -
\gamma\mathbb{J}\R)$) for each Newton iteration.
The inversion of $ A \ve{x} = \ve{b}$ is done iteratively with GMRES. GMRES can
further be preconditioned.
