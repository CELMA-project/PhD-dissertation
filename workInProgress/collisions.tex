...
We will here follow the derivation of the electron-ion and the ion-ion collision frequency \cite{Goldston1995} in order to derive an estimate for the elastic electron-neutral and ion-neutral collision frequency.
...
However, according to \cite{Goldston1995}, the analysis yields the correct result within factors of orders of unity.
