...
We will here follow the derivation of the electron-ion and the ion-ion collision frequency \cite{Goldston1995book} in order to derive an estimate for the elastic electron-neutral and ion-neutral collision frequency.
