...
\begin{align*}
 ...
 - \frac{1}{m_i}T_{e,0}\frac{1}{\rho_s}n_0T_e \partial_\| n_e
 - n_0\om_{ci}c_s n \nu_{i n}u_{i,\|}
 \\
 %
 =&
 ...
 - \frac{c_s}{\rho_s}n_0c_s u_{i,\|}\partial_\|\L( n \L[u_{i,\|}+ u_{e,\|} \R]\R)
   \\&
 + 0.51 \om_{ci}c_sn_0\nu_{ei} \frac{u_{i,\|}}{\mu} \grad_\perp^2 n
 - c_s^2\frac{1}{\rho_s}n_0T_e \partial_\| n_e
 - n_0\om_{ci}c_s n \nu_{i n}u_{i,\|}
 \\
 %
 =&
 ...
 - \om_{ci}n_0c_s u_{i,\|}\partial_\|\L( n \L[u_{i,\|}+ u_{e,\|} \R]\R)
   \\&
 + 0.51 \om_{ci}c_sn_0\nu_{ei} \frac{u_{i,\|}}{\mu} \grad_\perp^2 n
 - c_s\om_{ci}n_0T_e \partial_\| n_e
 - n_0\om_{ci}c_s n \nu_{i n}u_{i,\|}
 \\
 %
  \partial_t\L( n u_{i,\|}\R)
...
\begin{align*}
 ...
 - 0.51\om_{ci}en_0c_s \nu_{ei}j_\|
   \\&
   + \frac{m_i}{m_i}\frac{e}{m_e}T_{e,0}\frac{1}{\rho_s}n_0 T_e \partial_\| n_e
...
=&
 ...
 - 0.51\om_{ci}en_0c_s \nu_{ei}j_\|
   \\&
   + \frac{m_i}{m_e}e\frac{T_{e,0}}{m_i}\frac{1}{\rho_s}n_0 T_e \partial_\| n_e
...
=&
 ...
 - 0.51\frac{c_s}{\rho_s}en_0c_s \nu_{ei}j_\|
   \\&
   + \mu e\frac{c_s^2}{\rho_s}n_0 T_e \partial_\| n_e
