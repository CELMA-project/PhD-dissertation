...
Normalization of parallel current equation, using
$\ve{E}=\frac{\wt{E}T_e}{e\rho_s}$
% FIXME: Above
%
\begin{align*}
...
=&
 ...
 - 0.51 \nu_{ei}j_\|
   + \mu T_e \partial_\| n
   - \mu n \partial_\|\phi + \mu A_\| n \partial_t \ln(n)
 + n \L(\nu_{e n}u_{e,\|} - \nu_{i n}u_{i,\|} \R)
 \\
=&
 - \frac{1}{JB}\L\{\phi, j_{\|}\R\}
 ...
 - 0.51 \nu_{ei}j_\|
   ...
   - n \partial_\|\phi + A_\| n \partial_t \ln[n] \R)
 + n \L(\nu_{e n}u_{e,\|} - \nu_{i n}u_{i,\|} \R)
 \note{$T_e$ constant}
 \\
 \partial_t j^M_\|
...
%
FIXME:
For numerical purposes, in order for $A_\|$ not to be much bigger than the rest
of the quantities, we renormalize $A_{\|, \text{old}} = \frac{1}{2}\b A_{\|, \text{new}}$.
...
=&
 ...
 - 0.51 \nu_{ei}j_\|
   + \mu n \L(\partial_\|\L[ T_e\ln(n) - \phi\R]
   + \frac{1}{2}\b A_\| \partial_t \ln[n] \R)
   \\&
   + n \L(\nu_{e n}u_{e,\|} - \nu_{i n}u_{i,\|} \R)
 \numberthis
