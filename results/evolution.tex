...
\Cref{fig:modeRotation} indicates how the perturbations are both rotating and growing at the same time.

YOU ARE HERE: RESTRUCTURE THE TEXT


The poloidal plane is at the $\rho$ corresponding to the largest density gradient.
...
In other words, the perturbations are moving in the electron diamagnetic direction.
