...
The aboslute values of the energies are of approximately same order as for the CF case.
...
Secondly, the time trace of the density fluctuation appear more periodic than those observed in \cref{fig:combinedPlots008} for the CF case.
