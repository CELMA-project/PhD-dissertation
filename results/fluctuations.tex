...
This radial flux will be discussed more in depth in \cref{sec:fluxes}, but for now it suffices to say that if the radial flux approaches the levels of the parallel flux, the profiles will flatten as depicted in the two top-most plots in \cref{fig:posOfFluct01}.
%
\begin{figure}[h!]
    \begin{center}
...
Similar findings has been done at JET in \cite{Xu2009}.
