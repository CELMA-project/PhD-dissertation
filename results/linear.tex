...
This is essentially is a statement that the perturbations are infinitly long in the $x$-direction.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[h]{0.45\textwidth}
       ...
       \caption{Growth rates and angular frequencies obtained from \cref{eq:analyticDisp}.}
...
\footnote{Altough the time traces of \cref{fig:fourierStable} shows a more complex behavior than simly growing or simplify decaying, we conclude that the mode is stable against perturbations as they remain small for all times.
    Every "attempt" of growth is followed by a raprid decay.
    The growth is obseved if the mode stops rotating.
