...
This low ionization level is also the only one which does not reach a saturated steady state, but rather saturates in a situation where the modes are rotating whitout growing.
