...
$\L\{\L(\partial_{\rho} \phi\R)^2,n\R\}$ & $\rho$ & $2.00$ & $2.00$ & $1.60\cdot10^{-7}$ & $2.43\cdot10^{-8}$ & \Cref{eq:MESf1} for $n$ and \cref{eq:arakawaUE} for $\phi$ & $n_\theta=2^{12}$\\
$\L\{\L(\partial_{\rho} \phi\R)^2,n\R\}$ & $\theta$ & $1.35$ & $1.46$ & $1.12\cdot10^{-8}$ & $8.41\cdot10^{-8}$ & \Cref{eq:MESf1} for $n$ and \cref{eq:arakawaUE} for $\phi$ & $n_\rho=2^{12}$, convergence found until $n_\theta=2^{9}$\\
\hline\hline
\end{tabular}
}}
