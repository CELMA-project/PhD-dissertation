...
\end{table}
%
Higher parallel coefficients are used in the parallel direction as the background gradients in the parallel direction are much more gradual than the background gradients in the perpendicular gradients.
