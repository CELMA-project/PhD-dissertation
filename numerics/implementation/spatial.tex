...
\begin{itemize}[noitemsep]
    \item[$\bullet$] $u_{e,\|}\partial_\|\ln(n)$
    \item[$\bullet$] $nu_{e,\|}\partial_\| u_{i,\|}$
    \item[$\bullet$] $nu_{i,\|}\partial_\| u_{e,\|}$
    \item[$\bullet$] $\frac{j_{\|}}{n}\partial_\| u_{e,\|}$
    \item[$\bullet$] $u_{i,\|}\partial_\| \L(nu_{e,\|}\R)$
\end{itemize}
%
