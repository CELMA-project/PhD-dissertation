...
\end{table}
%
The standard centered finite difference stencils has been used (see \cite{Leveque2007book} for details).
...
\end{itemize}
%
note that whereas the upwinding makes the system more stable, it does so by introducing heavy damping on the system through diffusion introduced by the discretization \cite{Leveque2007book}.
