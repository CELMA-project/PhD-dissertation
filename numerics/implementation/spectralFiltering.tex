...
Although sufficiently high viscosities or diffusion can prevent aliasing (such that all the higher modes are damped out), they typically also damp on modes which we would like to include in our simulation.
...
\end{align*}
%
By rearranging \cref{eq:wavelen}, we find that the max allowed mode number for the circumference $C$ at radius $\rho$ is
%
\begin{align*}
