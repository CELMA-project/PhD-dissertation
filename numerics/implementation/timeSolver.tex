...
BOUT++ provides a variety of time sovlers, but the \texttt{cvode}\cite{Hindmarsh2012book} has been found to be a robust and fast time solver for solving \cref{eq:celma_dens,eq:celma_mom_dens,eq:celma_j_par,eq:celma_vortD_evolution} in time%
...
By a generic LMM, \cref{eq:MOL} can be written
%
\begin{align*}
