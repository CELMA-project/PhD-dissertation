...
\end{align*}
%
and from figure \ref{fig:etas} we see that $\eta_{\a,0} \gg \eta_{\a,j} \quad j \in \{1,2,3,4\}$ for the parameter range that we are interested in.
...
In Clebsch coordinates, we have that $\ve{u}_{E}$ is given by equation \ref{app:ExB}, which means that we get
%
\begin{align*}
    \ve{u}_E
    =&\frac{1}{JB}
