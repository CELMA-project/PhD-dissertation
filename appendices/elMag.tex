We will here continue the derivation of equation (\ref{eq:curNormE}) when keeping the $\partial_t \ve{A}$ term.
We have that
%
\begin{align*}
    E_\| = \ve{b}\cdot\ve{E}
...
In other words, equation (\ref{eq:curNorm}) can be rewritten to
%
\begin{align*}
 \partial_t j_\|
=&
