We will here continue the derivation of equation (\ref{eq:curNormE}) when
keeping the $\partial_t \ve{A}$ term. We have that
%
\begin{align*}
    E_\| = \ve{b}\cdot\ve{E}
...
\end{align*}
%
and from equation (\ref{eq:coloumbGauge}) that
%
\begin{align*}
...
\end{align*}
%
We can normalize Amp{\`e}re's law, using
$\ve{A}=\ve{\tilde{A}}\frac{T_e}{ec_s}$, which gives
%
\begin{align*}
   en_0c_s j_\|
...
of the quantities, it is common practice to renormalize
$A_{\|, \text{old}} = \frac{1}{2}\b A_{\|, \text{new}}$.
